...
<div class="">
			...
			<div class="x_panel">
				<div class="x_title">
					...
					<h2><?php if(isset($_GET['viewhistory'])) { 
					  ...
					  echo "User History";}else {echo "User's Pages"; }?></h2>
	...
	<tr>
		<td><?php echo "Permanent Address - ".$rowe['0']['p_address']."<br/>".$rowe['0']['p_city']."-".$rowe['0']['p_pincode'].",".$rowe['0']['p_state']."<br/>".$landline."".$mobile."";?></td>
	</tr>
	<tr>
			<td colspan="5">
			<hr/>
	...
	<tr>
	<td  id = "ptad"><b>Instl Period(M/D/Y)</b></td>
		<td  id = "ptad"><?php if($tomonth<10) { echo $rowe['0']['install_from']." to 0".$tomonth."/".$install_tod."/20".$toyear;}else { echo $rowe['0']['install_from']." to ".$tomonth."/".$install_tod."/20".$toyear; }?></td>
	...
	<div>
		<table>
		<tr>
			<th id = "ptad">Year</th><th id = "ptad">Principal</th><th id = "ptad">Interest</th><th id = "ptad">EMI</th><th id = "ptad">Received Amount</th><th id = "ptad">Penalty</th><th id = "ptad">Balance</th>
			...
			?>
                                         ...
                                         <div class="panel">
                                            <a class="panel-heading" role="tab" id="headingOne" data-toggle="collapse" data-parent="#accordion" href="#heading<?php  echo ""."20".$year; ?>" aria-expanded="false" aria-controls="collapse<?php  echo ""."20".$year; ?>">
                                                <h4 class="panel-title"><table><tr  ><td id = "ptad"><?php  echo ""."20".$year; ?></td><td id = "ptad"><?php   echo floor($calculatept["20".$year]['trpr']); ?></td><td id = "ptad"><?php echo floor($calculatept["20".$year]['tinterest']); ?></td><td id = "ptad"><?php  echo floor($calculatept["20".$year]['trpr']+$calculatept["20".$year]['tinterest']);?></td><td id = "ptad"> <?php echo $calculatept["20".$year]['tamountr'];?></td><td id = "ptad"><?php echo $penaltyt["20".$year]; ?></td><td id = "ptad"><?php  echo floor($calculatept["20".$year]['balance']); ?></td></tr></table></h4>
                                            </a>
                                            ...
                                            <div id="heading<?php  echo ""."20".$year; ?>" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                                                <div class="panel-body">
                                                    ...
                                                    <table class="table table-bordered">
                                                       <thead>
                                                            <tr>
                                                              <th id = "ptad">Month</th><th id = "ptad">Principal</th><th id = "ptad">Interest</th><th id = "ptad">EMI</th><th id = "ptad">Recieved Amount</th><th>Penalty</th><th id = "ptad">Balance</th>
                                                            </tr>
                                                        </thead> 
                                                        <tbody>
														<?php 
											...
											<tr>
															   ...
															   <td><?php  if(floor($mont['interest']+$mont['rpr'])-$mont['amountr']>2 &&  $mont['day']<date('d') && $year<=date('y')&& date('m')>=date('m',strtotime($mont['mone']))) { echo $penalty;} else { if(isset($mont['dayf']) && $mont['dayf']!=""){if($mont['day']<$mont['dayf']){ echo $penalty;} }  else { if($year<date('y')){	  echo $penalty;} if($year == date('y') && date('m')>=date('m',strtotime($mont['mone']))) {   echo $penalty;}} } ?>
			...
			<?php		
				...
				<table id="example" class="table table-striped responsive-utilities jambo_table">
					 ...
					 <thead>
                      ...
                      <th>Amt Financed</th>
					  <th>Recieved Principal</th>
					  <th>Recieved Interest</th>
					  <th>Penalty(Due)</th>
