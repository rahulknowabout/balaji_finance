...
$query = "select * from financeuser INNER JOIN financestatement ON financeuser.agreement_no = financestatement.agreement_no  where financeuser.agreement_no = '".$_GET['agreement_no']."'";
	...
	//echo $rowe['0']['amt_financed'];
		...
		// echo $emim;
		  ...
		  //echo $mper;
		   ...
		   $month =  date('m',strtotime($rowe['0']['install_from']))+1;
	...
	<tr>
		<td><b>".$rowe['0']['p_city']."-".$rowe['0']['p_pincode']." - Ph:".$rowe['0']['landline1']."<br />
Mobile:".$rowe['0']['mobile1']."</b></td>
	...
	<?php 
					...
					$installment_month = date('m',strtotime($rowe['0']['install_from']))+1;
	...
	<table border=\"1\" style = \"border-collapse: collapse;width:100%;\">
		...
		<tr>
			...
			<th  id = \"ptad\" width = \"16.66%\">Date</th><th  id = \"ptad\" width = \"16.66%\">Particular's</th><th  id = \"ptad\"width = \"16.66%\">Increased By(Rs):</th><th  id = \"ptad\" width = \"16.66%\">Decreased By(Rs):</th><th  id = \"ptad\" width = \"8.33%\">Penalty Due(Rs):</th><th  id = \"ptad\" width = \"8.33%\">Penalty Recieve (Rs):</th><th  id = \"ptad\" width = \"16.66%\">Paid(Rs):</th>
